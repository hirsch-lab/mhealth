...
class PatientDataLoaderTest(testing.TestCase):
    ...
    def test_load_everion_data_tz_zurich(self):
        ...
        df = loader.load_everion_patient_data(dir_name=dir_name,
    ...
    def test_load_extra_patient_data(self):
        ...
        loader = PatientDataLoader()
        filename = os.path.join(extra_data_dir_name, 'extra_data.csv')
        dict = loader.load_extra_patient_data(filename=filename)
